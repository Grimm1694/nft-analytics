...
export const GlareCard = ({
  ...
  // Adjusted container style for smaller card size
  const containerStyle = {
    ...
    "--foil-size": "100%",
    "--opacity": "0",
    "--radius": "24px", // Reduced radius for a smaller card
    "--easing": "ease",
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[220px] [aspect-ratio:17/21]" // Reduced width for smaller card size
      ref={refElement}
      onPointerMove={(event) => {
